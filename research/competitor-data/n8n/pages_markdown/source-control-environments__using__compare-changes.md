# Compare changes with workflow diffs | n8n Docs

Source: https://docs.n8n.io/source-control-environments/using/compare-changes
Lastmod: 2026-04-14
Description: Use workflow diffs to compare local and remote changes
# Compare changes with workflow diffs[#](#compare-changes-with-workflow-diffs "Permanent link")
...
## Accessing workflow diffs[#](#accessing-workflow-diffs "Permanent link")
...
## Understanding the workflow diff view[#](#understanding-the-workflow-diff-view "Permanent link")

When you open a workflow diff, n8n displays two workflows stacked vertically:

### When pushing[#](#when-pushing "Permanent link")
...
### When pulling[#](#when-pulling "Permanent link")
...
## Reviewing node changes[#](#reviewing-node-changes "Permanent link")
...
## Viewing the summary of changes[#](#viewing-the-summary-of-changes "Permanent link")
...
## Navigating through each change[#](#navigating-through-each-change "Permanent link")
...
## Who can use workflow diffs[#](#who-can-use-workflow-diffs "Permanent link")
