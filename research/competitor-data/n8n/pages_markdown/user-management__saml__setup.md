...
Once you enable "User role provisioning", the next time any user logs in via SAML, any access they've been granted inside n8n, which isn't reflected in the n8n\_instance\_role and n8n\_projects will be removed from that user.
...
#### Configuring n8n\_instance\_role attribute[#](#configuring-n8n_instance_role-attribute "Permanent link")
...
#### Configuring n8n\_projects attribute[#](#configuring-n8n_projects-attribute "Permanent link")
