...
### Create an External Client App (recommended)[#](#create-an-external-client-app-recommended "Permanent link")
...
### Create a Connected App (legacy)[#](#create-a-connected-app-legacy "Permanent link")
...
### Create an External Client App (recommended)[#](#create-an-external-client-app-recommended_1 "Permanent link")
...
### Create a Connected App (legacy)[#](#create-a-connected-app-legacy_1 "Permanent link")
...
### Connection issues when authenticating with Salesforce from n8n Cloud[#](#connection-issues-when-authenticating-with-salesforce-from-n8n-cloud "Permanent link")
