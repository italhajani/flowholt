# External hooks | n8n Docs

Source: https://docs.n8n.io/hosting/configuration/external-hooks
Lastmod: 2026-04-14
...
### Hook files[#](#hook-files "Permanent link")
...
### Hook functions[#](#hook-functions "Permanent link")
...
### Registering frontend hooks[#](#registering-frontend-hooks "Permanent link")
