...
Source: https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.guardrails
Lastmod: 2026-04-14
...
### Text To Check[#](#text-to-check "Permanent link")
...
### Guardrails[#](#guardrails "Permanent link")
...
### Customize System Message[#](#customize-system-message "Permanent link")
