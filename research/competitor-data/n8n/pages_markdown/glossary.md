...
#### AI groundedness[#](#ai-groundedness)
...
#### AI retrieval-augmented generation (RAG)[#](#ai-retrieval-augmented-generation-rag)
...
#### cluster node (n8n)[#](#cluster-node-n8n)
...
#### data pinning (n8n)[#](#data-pinning-n8n)
...
#### entitlement (n8n)[#](#entitlement-n8n)
...
#### trigger node (n8n)[#](#trigger-node-n8n)
