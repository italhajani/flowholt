...
## Publishing to npm[#](#publishing-to-npm "Permanent link")
...
### Existing nodes[#](#existing-nodes "Permanent link")
...
## Ready to submit?[#](#ready-to-submit "Permanent link")
