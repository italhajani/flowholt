...
### Make Available in n8n Chat[#](#make-available-in-n8n-chat "Permanent link")

Choose whether to make the agent available to Chat Hub.

#### Agent Name[#](#agent-name "Permanent link")

The name of the agent on Chat Hub.

#### Agent description[#](#agent-description "Permanent link")
