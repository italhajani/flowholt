# Security settings | n8n Docs

Source: https://docs.n8n.io/security-settings
Lastmod: 2026-04-14
Description: Manage instance-wide security policies including MFA enforcement and personal space controls.
# Security settings[#](#security-settings "Permanent link")
...
## Enforce two-factor authentication[#](#enforce-two-factor-authentication "Permanent link")
...
## Personal space policies[#](#personal-space-policies "Permanent link")
...
### Sharing workflows and credentials[#](#sharing-workflows-and-credentials "Permanent link")
...
### Publishing workflows[#](#publishing-workflows "Permanent link")
