...
## Export entities[#](#export-entities "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 ``` | ``` n8n export:entities --outputDir=./outputs --includeExecutionHistoryDataTables=true ``` |
...
## Import entities[#](#import-entities "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 ``` | ``` n8n import:entities --inputDir ./outputs --truncateTables true ``` |
...
## Uninstall community nodes and credentials[#](#uninstall-community-nodes-and-credentials "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 ``` | ``` n8n community-node --uninstall --package <COMMUNITY_NODE_NAME> ``` |

For example, to uninstall the [Evolution API community node](https://www.npmjs.com/package/n8n-nodes-evolution-api), type:

|  |  |
| --- | --- |
| ``` 1 ``` | ``` n8n community-node --uninstall --package n8n-nodes-evolution-api ``` |

### Credentials[#](#credentials_2 "Permanent link")

Uninstall a community node credential:

|  |  |
| --- | --- |
| ``` 1 ``` | ``` n8n community-node --uninstall --credential <CREDENTIAL_TYPE> --userId <ID> ``` |
...
|  |  |
| --- | --- |
| ``` 1 ``` | ``` n8n community-node --uninstall --credential evolutionApi --userId 1234 ``` |
