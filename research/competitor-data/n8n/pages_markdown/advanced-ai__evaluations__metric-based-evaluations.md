# Metric-based evaluations | n8n Docs
...
### 2. Add metrics to workflow[#](#2-add-metrics-to-workflow "Permanent link")
...
### 3. Run evaluation and view results[#](#3-run-evaluation-and-view-results "Permanent link")
