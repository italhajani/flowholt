...
## *`Array`*.**`append()`**[#](#arrayappend "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = ['forget', 'me'] arr.append('not') //=> arr = ['forget', 'me', 'not'] ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 4 5 ``` | ``` // arr = [9, 0, 2] arr.append(1, 0) //=> [9, 0, 2, 1, 0]  // Consider using spread syntax instead [...arr, 1, 0]  //=> [9, 0, 2, 1, 0] ``` |

## *`Array`*.**`average()`**[#](#arrayaverage "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [12, 1, 5] arr.average() //=> 6 ``` |

## *`Array`*.**`chunk()`**[#](#arraychunk "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [1, 2, 3, 4, 5, 6] arr.chunk(2) //=> [ [1,2], [3,4], [5,6] ] ``` |

## *`Array`*.**`compact()`**[#](#arraycompact "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [2, null, 1, ""] arr.compact() //=> [2, 1] ``` |

## *`Array`*.**`concat()`**[#](#arrayconcat "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr1 = ['Nathan', 'Jan'] arr1.concat(['Steve', 'Bill']) // ['Nathan', 'Jan', 'Steve', 'Bill'] ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 4 ``` | ``` // arr1 = [5, 4] // arr2 = [100, 101] // arr3 = ['a', 'b'] arr1.concat(arr2, arr3) // [5, 4, 100, 101, 'a', 'b'] ``` |

## *`Array`*.**`difference()`**[#](#arraydifference "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [1, 2, 3] arr.difference([2, 3]) //=> [1] ``` |

## *`Array`*.**`filter()`**[#](#arrayfilter "Permanent link")
...
* `function()` (function) - A function to run for each array element. If it returns `true`, the element will be kept. Consider using [arrow function notation](”https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions”) to save space.
...
|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // Keep ages over 18 (using arrow function notation): // ages = [12, 33, 16, 40] ages.filter(age => (age > 18)) //=> [33, 40] ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 4 5 6 ``` | ``` // Keep names under 5 letters long (using arrow function notation): // names = ['Nathan', 'Bob', 'Sebastian'] ages.filter(age => (age.length < 5)) //=> ["Bob"]  // Or using traditional function notation: ages.filter(function(age){return age.length < 5}) //=> ["Bob"] ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // Keep numbers at odd indexes // nums = [1, 7, 3, 10, 5] ages.filter((num, index) => {return index%2 != 0}) //=> [7, 10] ``` |

## *`Array`*.**`find()`**[#](#arrayfind "Permanent link")
...
* `function()` (function) - A function to run for each array element. As soon as it returns `true`, that element will be returned. Consider using [arrow function notation](”https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions”) to save space.
* `element` (any) - The value of the current element
* `index` (Number) - optional - The position of the current element in the array (starting at 0)
...
|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // Find first age over 18 (using arrow function notation): // ages = [12, 33, 16, 40] ages.find(age => (age > 18)) //=> 33 ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 4 5 6 ``` | ``` // Find first name under 5 letters long (using arrow function notation): // names = ['Nathan', 'Bob', 'Sebastian'] ages.find(age => (age.length < 5)) //=> 'Bob'  // Or using traditional function notation: ages.find(function(age){return age.length < 5}) //=> 'Bob' ``` |

## *`Array`*.**`first()`**[#](#arrayfirst "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = ['quick', 'brown', 'fox'] arr.first() //=> 'quick' ``` |

## *`Array`*.**`includes()`**[#](#arrayincludes "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // names = ["Bob", "Bill", "Nat"]; names.includes("Nat") //=> true names.includes("Nathan") //=> false ``` |

## *`Array`*.**`indexOf()`**[#](#arrayindexof "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // names = ["Bob", "Bill", "Nat"]; names.indexOf("Nat") //=> 2 ``` |

|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // names = ["Bob", "Bill", "Nat"]; names.indexOf("Nathan") //=> -1 ``` |

## *`Array`*.**`intersection()`**[#](#arrayintersection "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [1, 2] arr.intersection([2, 3]) //=> [2] ``` |

## *`Array`*.**`isEmpty()`**[#](#arrayisempty "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [] arr.isEmpty() //=> true ``` |

|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = ['quick', 'brown', 'fox'] arr.isEmpty() //=> false ``` |

## *`Array`*.**`isNotEmpty()`**[#](#arrayisnotempty "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = ['quick', 'brown', 'fox'] arr.isNotEmpty() //=> true ``` |

|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [] arr.isNotEmpty() //=> false ``` |

## *`Array`*.**`join()`**[#](#arrayjoin "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = ['Wind', 'Water', 'Fire'] a.join(" + ") //=> 'Wind + Water + Fire' ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // arr = ['Wind', 'Water', 'Fire'] a.join() //=> 'Wind,Water,Fire' a.join("") //=> 'WindWaterFire' ``` |

## *`Array`*.**`last()`**[#](#arraylast "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = ['quick', 'brown', 'fox'] arr.last() //=> 'fox' ``` |

## *`Array`*.**`length`**[#](#arraylength "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // names = ["Bob", "Bill", "Nat"]; names.length //=> 3 ``` |

## *`Array`*.**`map()`**[#](#arraymap "Permanent link")
...
* `function()` (function) - A function to run for each array element. In the new array, the output of this function takes the place of the element. Consider using [arrow function notation](”https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions”) to save space.
* `element` (any) - The value of the current element
* `index` (Number) - optional - The position of the current element in the array (starting at 0)
* `array` (Array) - optional - The array of the current element. Rarely needed.
* `thisValue` (any) - optional - A value passed to the function as its `this` value. Rarely needed.
...
|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // Double all numbers (using arrow function notation): // nums = [12, 33, 16] nums.map(num => num*2) //=> [24, 66, 32] ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 4 5 6 ``` | ``` // Convert elements to uppercase (using arrow function notation): // words = ['hello', 'old', 'chap'] words.map(word => word.toUpperCase()) //=> ['HELLO', 'OLD', 'CHAP']]  // Or using traditional function notation: words.map(function(word){return word.toUpperCase()}) //=> ['HELLO', 'OLD', 'CHAP']] ``` |

## *`Array`*.**`max()`**[#](#arraymax "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [1, 12, 5] arr.max() //=> 12 ``` |

## *`Array`*.**`min()`**[#](#arraymin "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [12, 1, 5] arr.min() //=> 1 ``` |

## *`Array`*.**`pluck()`**[#](#arraypluck "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [{'name':'Nathan','age':42},{'name':'Jan','city':'Berlin'}] arr.pluck('name') //=> ["Nathan", "Jan"] ``` |

|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [{'name':'Nathan','age':42},{'name':'Jan','city':'Berlin'}] arr.pluck('age') //=> [42] ``` |

## *`Array`*.**`randomItem()`**[#](#arrayrandomitem "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // arr = ['quick', 'brown', 'fox'] arr.randomItem() //=> 'brown' arr.randomItem() //=> 'quick' ``` |

## *`Array`*.**`reduce()`**[#](#arrayreduce "Permanent link")
...
* `function()` (function) - A function to run for each array element. Takes the accumulated result and the current element, and returns a new accumulated result. Consider using [arrow function notation](”https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_functions”) to save space.
...
|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // Sum numbers (using arrow function notation): // nums = [12, 33, 16] nums.reduce((result, num) => (result+num), 0) //=> 61 ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 4 5 6 ``` | ``` // Join letters and uppercase (using arrow function notation): // chars = ['a', 'b', 'c'] chars.reduce((result, char) => (result+char.toUpperCase()), '') //=> 'ABC'  // Or using traditional function notation: chars.reduce(function(result, char){return result+char.toUpperCase()}, '') //=> 'ABC' ``` |

## *`Array`*.**`removeDuplicates()`**[#](#arrayremoveduplicates "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = ['quick', 'brown', 'quick'] arr.removeDuplicates() //=> ['quick', 'brown'] ``` |

## *`Array`*.**`renameKeys()`**[#](#arrayrenamekeys "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [{'name':'bob'},{'name':'meg'}] arr.renameKeys('name', 'x') //=> [{"x": "bob"},{"x": "meg"}]] ``` |

## *`Array`*.**`reverse()`**[#](#arrayreverse "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = ['dog', 'bites', 'man'] arr.reverse() //=> ['man', 'bites', 'dog'] ``` |

## *`Array`*.**`slice()`**[#](#arrayslice "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [1, 2, 3, 4, 5] arr.slice(2, 4) //=> [3, 4] ``` |

|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [1, 2, 3, 4, 5] arr.slice(2) //=> [3, 4, 5] ``` |

|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [1, 2, 3, 4, 5] arr.slice(-2) //=> [4, 5] ``` |

## *`Array`*.**`smartJoin()`**[#](#arraysmartjoin "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr => [{'field':'age','value':2},{'field':'city','value':'Berlin'}] arr.smartJoin('field','value') //=> {"age": 2, "city": "Berlin"} ``` |

## *`Array`*.**`sort()`**[#](#arraysort "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // No need for a param when sorting strings // arr = ['d', 'a', 'c', 'b'] arr.sort() //=> ['a', 'b', 'c', 'd'] ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 4 5 6 ``` | ``` // To sort numbers, you must use a function // arr = [4, 2, 1, 3] arr.sort((a, b) => (a - b)) //=> [1, 2, 3, 4]  // Or using traditional function notation: arr.sort(function(a, b){return a - b}) //=> [1, 2, 3, 4] ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // Sort in reverse alphabetical order // arr = ['d', 'a', 'c', 'b'] arr.sort((a, b) => b.localeCompare(a)) //=> ['d', 'c', 'b', 'a'] ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // Sort array of objects by a property // arr = [{name:'Zak'}, {name:'Abe'}, {name:'Bob'}] arr.sort((a, b) => a.name.localeCompare(b.name)) //=> [{name:'Abe'}, {name:'Bob'}, {name:'Zak'}] ``` |

## *`Array`*.**`sum()`**[#](#arraysum "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [12, 1, 5] arr.sum() //=> 18 ``` |

## *`Array`*.**`toJsonString()`**[#](#arraytojsonstring "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // obj = ['quick', 'brown', 'fox'] obj.toJsonString() //=> '["quick","brown","fox"]' ``` |

## *`Array`*.**`toSpliced()`**[#](#arraytospliced "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // Insert element at index 1 // months = ['Jan', 'Mar'] months.toSpliced(1, 0, "Feb") // ['Jan', 'Feb', 'Mar'] ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // Delete 2 elements starting at index 1 // arr = ["don't", "make", "me", "do", "this"] arr.toSpliced(1, 2) // ["don't", "do", "this"] ``` |

|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` // Replace 2 elements starting at index 1 // arr = ["don't", "be", "evil"] arr.toSpliced(1, 2, 'eat', 'slugs') // ["don't", "eat", "slugs"] ``` |

## *`Array`*.**`toString()`**[#](#arraytostring "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // words = ['make', 'my', 'day'] words.toString() //=> 'make,my,day' ``` |

## *`Array`*.**`union()`**[#](#arrayunion "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = [1, 2] arr.union([2, 3]) //=> [1, 2, 3] ``` |

## *`Array`*.**`unique()`**[#](#arrayunique "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 ``` | ``` // arr = ['quick', 'brown', 'quick'] arr.unique() //=> ['quick', 'brown'] ``` |
