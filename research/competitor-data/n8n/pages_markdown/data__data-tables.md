...
Source: https://docs.n8n.io/data/data-tables
Lastmod: 2026-04-14
...
## Working with data tables[#](#working-with-data-tables "Permanent link")
...
### Data Table node[#](#data-table-node "Permanent link")
...
### DataTable API endpoint[#](#datatable-api-endpoint "Permanent link")
...
### Data table tab[#](#data-table-tab "Permanent link")
...
2. Click the split button located in the top right corner and select **Create Data table**.
   ...
   [![Data table creation](../../_images/data/data-tables/create-data-table.png)](https://docs.n8n.io/_images/data/data-tables/create-data-table.png)
...
## Exporting and importing data[#](#exporting-and-importing-data "Permanent link")
...
## Considerations and limitations of data tables[#](#considerations-and-limitations-of-data-tables "Permanent link")
...
## Data tables versus variables[#](#data-tables-versus-variables "Permanent link")
