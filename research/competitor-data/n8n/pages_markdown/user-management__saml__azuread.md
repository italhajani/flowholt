# Azure AD SAML setup | n8n Docs

Source: https://docs.n8n.io/user-management/saml/azuread
Lastmod: 2026-04-14
Description: Use Azure AD with n8n.
# Azure AD SAML setup[#](#azure-ad-saml-setup "Permanent link")
...
## What n8n requires[#](#what-n8n-requires "Permanent link")
...
### Testing the configuration[#](#testing-the-configuration "Permanent link")
