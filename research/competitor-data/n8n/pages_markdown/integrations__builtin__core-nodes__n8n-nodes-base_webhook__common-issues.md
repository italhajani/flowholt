...
|  |  |
| --- | --- |
| ``` 1 ``` | ``` curl --request POST <https://your-n8n.url/webhook/path> --data 'key=value' ``` |
...
|  |  |
| --- | --- |
| ``` 1 ``` | ``` curl --request POST <https://your-n8n.url/webhook/path> --form 'key=@/path/to/file' ``` |
...
## Timeouts on n8n Cloud[#](#timeouts-on-n8n-cloud "Permanent link")
