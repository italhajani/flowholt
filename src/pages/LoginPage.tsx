...
import { isSupabaseConfigured, supabaseOAuthSignIn } from "@/lib/supabase";
    ...
    <div>
      ...
      <div className="flex flex-col gap-2.5">
        <OAuthButton
          ...
          onClick={() => isSupabaseConfigured ? supabaseOAuthSignIn("google").catch(e => setError(e.message)) : undefined}
        ...
        <OAuthButton
          ...
          onClick={() => isSupabaseConfigured ? supabaseOAuthSignIn("github").catch(e => setError(e.message)) : undefined}
        ...
        {!isSupabaseConfigured && (
          <p className="text-center text-[10px] text-zinc-400 -mt-0.5">OAuth requires Supabase — set VITE_SUPABASE_URL + VITE_SUPABASE_ANON_KEY</p>
        )}
      </div>
