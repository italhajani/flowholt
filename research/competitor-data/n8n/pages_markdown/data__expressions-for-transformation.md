# Expressions for data transformation | n8n Docs
...
# Expressions for data transformation[#](#expressions-for-data-transformation "Permanent link")
...
[![Creating expressions in the UI](../../_images/data/data-mapping/expressionDot.gif)](https://docs.n8n.io/_images/data/data-mapping/expressionDot.gif)
...
### Using expressions in credentials[#](#using-expressions-in-credentials "Permanent link")
...
## Example: Writing longer JavaScript as expressions[#](#example-writing-longer-javascript-as-expressions "Permanent link")
...
|  |  |
| --- | --- |
| ``` 1 2 3 4 5 6 ``` | ``` {{(()=>{   let end = DateTime.fromISO('2017-03-13');   let start = DateTime.fromISO('2017-02-13');   let diffInMonths = end.diff(start, 'months');   return diffInMonths.toObject(); })()}} ``` |
