...
## Delegated access for organisation-wide Microsoft integrations[#](#delegated-access-for-organisation-wide-microsoft-integrations "Permanent link")
...
### Register the app[#](#register-the-app "Permanent link")
...
### Generate a client secret[#](#generate-a-client-secret_1 "Permanent link")
...
### Configure API permissions[#](#configure-api-permissions "Permanent link")
...
### Add the redirect URI[#](#add-the-redirect-uri "Permanent link")
...
### Grant admin consent in n8n[#](#grant-admin-consent-in-n8n "Permanent link")
...
### Pre-configure credentials for users[#](#pre-configure-credentials-for-users "Permanent link")
...
### Required scopes by integration[#](#required-scopes-by-integration "Permanent link")
...
### Admin approval required during delegated access setup[#](#admin-approval-required-during-delegated-access-setup "Permanent link")
