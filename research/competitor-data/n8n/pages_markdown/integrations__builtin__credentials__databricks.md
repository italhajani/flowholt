# Databricks credentials | n8n Docs

Source: https://docs.n8n.io/integrations/builtin/credentials/databricks
Lastmod: 2026-04-14
...
# Databricks credentials[#](#databricks-credentials "Permanent link")
...
## Using a personal access token[#](#using-a-personal-access-token "Permanent link")
...
## Using OAuth2 (service principal)[#](#using-oauth2-service-principal "Permanent link")
...
### Create a service principal and OAuth secret[#](#create-a-service-principal-and-oauth-secret "Permanent link")
