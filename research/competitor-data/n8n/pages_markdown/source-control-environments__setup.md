# Set up source control | n8n Docs
...
## Step 3: Set up authentication[#](#step-3-set-up-authentication "Permanent link")

Configure authentication based on your chosen connection method.

### SSH authentication (using deploy keys)[#](#ssh-authentication-using-deploy-keys "Permanent link")
...
### HTTPS authentication (using Personal Access Tokens)[#](#https-authentication-using-personal-access-tokens "Permanent link")
