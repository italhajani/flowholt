# Save and publish | n8n Docs

Source: https://docs.n8n.io/workflows/publish
Lastmod: 2026-04-14
...
## How saving works[#](#how-saving-works "Permanent link")
...
## How publishing works[#](#how-publishing-works "Permanent link")
...
[![](../../_images/publish/publish-initial.png)](https://docs.n8n.io/_images/publish/publish-initial.png)

**Ready to publish** When the workflow is not yet published but has changes, the button becomes active.

[![](../../_images/publish/publish-ready.png)](https://docs.n8n.io/_images/publish/publish-ready.png)

**Published, up to date** The workflow is currently published and there are no new changes since the last publish.

[![](../../_images/publish/published.png)](https://docs.n8n.io/_images/publish/published.png)
...
[![](../../_images/publish/published-changes.png)](https://docs.n8n.io/_images/publish/published-changes.png)
...
[![](../../_images/publish/published-invalid.png)](https://docs.n8n.io/_images/publish/published-invalid.png)
...
[![](../../_images/publish/published-error.png)](https://docs.n8n.io/_images/publish/published-error.png)

## How collaboration works[#](#how-collaboration-works "Permanent link")
...
## Checking publishing status[#](#checking-publishing-status "Permanent link")

On the **Workflows** page, if a workflow is published an indicator will be displayed on the card.

[![](../../_images/publish/published-indicator-wf-list.png)](https://docs.n8n.io/_images/publish/published-indicator-wf-list.png)

## Publishing a workflow[#](#publishing-a-workflow "Permanent link")
...
[![](../../_images/publish/publish-modal.png)](https://docs.n8n.io/_images/publish/publish-modal.png)

## Naming versions[#](#naming-versions "Permanent link")
...
[![](../../_images/publish/publish-dropdown.png)](https://docs.n8n.io/_images/publish/publish-dropdown.png)

To name a version from the version history page:

1. Open the version history by selecting the history icon in the header.
2. On the version you want to name, select **Options** ![Options icon](../../_images/common-icons/three-dot-options-menu.png).
3. Select **Name version**.
4. Enter a name and optional description.
5. Select **Save**.

## Managing version history[#](#managing-version-history "Permanent link")
...
## How to unpublish a workflow[#](#how-to-unpublish-a-workflow "Permanent link")
