---
title: "App visibility | Custom Apps Documentation | Make Developer Hub"
url: https://developers.make.com/custom-apps-documentation/create-your-first-app/app-visibility
scraped_at: 2026-04-21T12:41:37.695912Z
---
...
### hashtag Deletion of a webhook, connection, RPC, or custom IML function
...
### hashtag Deletion of a public app

Once the app is published, it is not possible to delete the app or make it private again.

If you wish to have your public app deleted, contact our support team arrow-up-right and we will remove the app from your account.

### hashtag Deletion of a module, webhook, connection, RPC, or custom IML function
...
```
[DO NOT USE] My unwanted module
```

### hashtag Distribution control of modules
...
Approved apps are available to any user in Make. If you want to have your app available to all Makers, review the app review procedure to ensure that your app follows best practices.

Once you make sure your app follows our conditions and best practices, you can request an app review .

If the app passes our review process , it becomes available for everyone to use. That mean's that any user on Make can add your app to his/her scenario and use it.
